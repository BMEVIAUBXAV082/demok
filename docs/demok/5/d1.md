...
!!! example "Demo beadandó – f1.png"
    Képernyőkép az Airflow Grid View-ról, ahol az `etl_taskflow` DAG legalább egy sikeres futása látható (zöld négyzetek), és a `retry_demo` DAG retry állapotai.
